    ...
    years: {
        '2026': {
            ...
            payments: [
                ...
                // Клиент Б полностью оплатил ПОСЛЕ покупки 7 дней назад
                {
                    date: getDateDaysAgo(3),
                    client: 'Клиент Б',
                    amount: 3000,
                ...
                // Теперь Клиент Б не должен показываться в уведомлениях
            ]
        }
    }
};
...
console.log('   - Клиент Б: НЕ должен быть в уведомлениях (долг погашен полностью)');
